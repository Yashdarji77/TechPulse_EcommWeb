...
export const incrementDecrement = (event, id, stock, price) => {
  ...
  localStoragePrice = price * quantity; //Here Price is actual Price
  localStoragePrice = Number(localStoragePrice.toFixed(2)); //after decimal you will ony get 2 digits
